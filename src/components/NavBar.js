...
const NavBar = (props) => {
    return(
        <div>
	        <AppBar position="fixed" style={{ background: '#5D909A', boxShadow: 'none'}}>
		            <Toolbar style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
		            	<div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
							...
							<Button onClick={() => window.open("https://github.com/jeronimomora", "_blank")}>
				                <SvgIcon style={{ color: 'white'}}>
		                ...
		                {
		                	props.isCompact ? <SimpleMenu onMenuClick={props.onMenuClick} color="inherit"/> : 
		                	<div>
