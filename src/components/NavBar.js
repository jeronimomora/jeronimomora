		            ...
		            <Toolbar style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
		            	<div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
			                <Typography variant="title" color="inherit">
			                	{ props.isMobile ? "Jeronimo" : "Jeronimo Mora" }
			                </Typography>
			                <IconButton style={{ marginLeft: 15 }} onClick={() => window.open("https://linkedin.com/in/jeronimomora", "_blank")}>
				                <SvgIcon style={{ color: 'white'}}>
								    <path d="M21,21H17V14.25C17,13.19 15.81,12.31 14.75,12.31C13.69,12.31 13,13.19 13,14.25V21H9V9H13V11C13.66,9.93 15.36,9.24 16.5,9.24C19,9.24 21,11.28 21,13.75V21M7,21H3V9H7V21M5,3A2,2 0 0,1 7,5A2,2 0 0,1 5,7A2,2 0 0,1 3,5A2,2 0 0,1 5,3Z" />
								</SvgIcon>
							</IconButton>		                
							<IconButton onClick={() => window.open("https://github.com/jeronimomora", "_blank")}>
				                <SvgIcon style={{ color: 'white'}}>
		                ...
		                {
		                	props.shouldHaveNavigationMenu ? <SimpleMenu onMenuClick={props.onMenuClick} color="inherit"/> : 
		                	<div>
