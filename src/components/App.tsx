  ...
  onMenuClick(section: NavigationConstantType) {
    switch (section) {
      case navigationConstants.CAREER_PROFILE:
        this.scrollTo({
          top: this.careerProfileRef.current!.offsetTop - SECTION_MARGIN_TOP,
        });
        break;
      case navigationConstants.SKILLS:
        this.scrollTo({
          top: this.skillsRef.current!.offsetTop - SECTION_MARGIN_TOP,
        });
        break;
      case navigationConstants.WORK_EXPERIENCE:
        this.scrollTo({
          top: this.workExperienceRef.current!.offsetTop - SECTION_MARGIN_TOP,
        });
        break;
      case navigationConstants.EDUCATION:
        this.scrollTo({
          top: this.educationRef.current!.offsetTop - SECTION_MARGIN_TOP,
        });
        break;
      default:
    }
